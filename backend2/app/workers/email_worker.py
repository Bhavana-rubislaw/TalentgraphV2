...
def send_notification_email_task(delivery_id: int):
    ...
    with Session(engine) as session:
        try:
            ...
            # Use stored email content (already generated by NotificationService)
            subject = delivery.subject
            html_body = delivery.html_body or "No content"  # Fallback
...
def queue_notification_email(
    ...
    Args:
        ...
        html_body: Generated HTML email body
